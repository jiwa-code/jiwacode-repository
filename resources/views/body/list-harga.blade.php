            ...
            <div class="tw-snap-center md:tw-snap-none tw-shrink-0 tw-w-11/12 tw-bg-[#FBFBFB] tw-rounded-sm mx-auto tw-shadow-md tw-py-4">
                <div class="md:tw-flex">
                    ...
                    <div class="tw-w-10/12 md:tw-w-8/12 tw-mx-auto tw-mt-2 ">
                        ...
                        {{--  --}}
                        <div class="tw-my-4 md:tw-my-2 tw-flex">
                            <div class="tw-w-6/12 ">
                                <p class=" tw-font-semibold tw-text-sm">Hosting gratis selama 1 tahun</p>
                                <p class=" tw-font-semibold tw-text-sm">Domain gratis selama 1 tahun</p>
                                <p class=" tw-font-semibold tw-text-sm">Desain Kostumisasi</p>
                            </div>
                            <div class="tw-w-5/12 tw-mx-auto ">
                                <p class=" tw-font-semibold tw-text-sm">Revisi sampe mampus</p>
                                <p class=" tw-font-semibold tw-text-sm">naon deui ieu isini
                                </p>
                                <p class=" tw-font-semibold"><s>Israel</s></p>
                            </div>
                        </div>
                    </div>
                    <div class="md:tw-w-4/12 tw-invisible md:tw-visible md:tw-h-12 md:tw-pt-5 ">
                        <p class="md:tw-text-2xl  2xl:tw-text-5xl xl:tw-text-3xl lg:tw-text-4xl md:tw-my-6 tw-text-[#595959] text-center tw-font-semibold">Rp.<span class="gradient-font"> 799K </span></p>
                        <p class="md:tw-text-center md:tw-text-white tw-text-sm"><a href="" class="tw-rounded-md tw-py-2 md:tw-px-3 hover:md:tw-animate-pulse" id="bg-gradient">Ambil Paket</a></p>
                    </div>
                    <div class="tw-mt-4 tw-w-12/12 text-center tw-mb-6 md:tw-hidden">
                    <a href="" class="tw-w-4/12  tw-text-white tw-py-3 tw-px-12 tw-rounded-md " id="bg-gradient">Ambil Paket</a>
                </div>
                </div>
            </div>
